...
function googleFail($message) {
    header('Location: ../../assets/html/login.html?google_error=' . rawurlencode($message));
    exit;
}
...
try {
    ...
    header('Location: ../../assets/html/' . ($user['role'] === 'student' ? 'student_dashboard.html' : 'dashboard.html'));
    exit;
